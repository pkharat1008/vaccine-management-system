...
void Vaccine::search_by_citizenship()
{
	...
	cout<<"\n\n\n\nNumber of people vaccinated  by this Citizenship Number is/are = \t"<<p;
    in.close();
}
...
void Vaccine::search_by_age()
{
   ...
   while(!in.eof())
    ...
    cout<<"\n\n\n\nNumber of people vaccinated  by this age is/are = \t"<<p;
    in.close();
}
void Vaccine::search_by_profession()
{
   ...
   while(!in.eof())
    ...
    cout<<"\n\n\n Number of people vaccinated by this profession is/are = \t"<<p<<endl;
    in.close();
}
void Vaccine::search_by_gender()
{
    ...
    cout<<"\n\n\n Number of people vaccinated by this gender is/are = \t"<<p<<endl;
    in.close();
}
void Vaccine::search_by_vaccine()
{
   ...
   while(!in.eof())
    ...
    cout<<"\n\n\n Number of people vaccinated by this vaccine is/are = \t"<<p<<endl;
    in.close();
}
void show()
{
...
int password()
{
    ...
    cin>>capt;
    if( (strcmp(cname,"pranjal")==0) && (strcmp(pass,"pranjal")==0) && cap==capt)
        return 1;
    else
        return 0;
}
...
int main()
 {
     ...
     int k=3;
     int num_vac;
    cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 ** VACCINE MANAGEMENT SYSTEM ** \xB3-\xB3\xB2=\xB2=\xB2\n\n"<<endl;
     B:
    system("cls");
